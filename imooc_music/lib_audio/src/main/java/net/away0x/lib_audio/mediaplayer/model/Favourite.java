package net.away0x.lib_audio.mediaplayer.model;
...
import net.away0x.lib_audio.mediaplayer.db.DaoSession;
import net.away0x.lib_audio.mediaplayer.db.AudioBeanDao;
import net.away0x.lib_audio.mediaplayer.db.FavouriteDao;
