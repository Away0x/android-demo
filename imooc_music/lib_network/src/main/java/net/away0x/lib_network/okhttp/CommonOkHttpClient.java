package net.away0x.lib_network.okhttp;

import net.away0x.lib_network.okhttp.response.CommonFileCallback;
import net.away0x.lib_network.okhttp.response.CommonJsonCallback;
...
public class CommonOkHttpClient {
    ...
    private static OkHttpClient mOkHttpClient; // 单例
    ...
    static {
         ...
         * 添加公共请求头
         */
        okhttpClientBuilder.addInterceptor(new Interceptor() { // 拦截器
            @Override
