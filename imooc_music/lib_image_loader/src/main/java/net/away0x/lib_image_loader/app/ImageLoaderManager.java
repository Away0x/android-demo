package net.away0x.lib_image_loader.app;
...
import net.away0x.lib_image_loader.R;
import net.away0x.lib_image_loader.image.Utils;
...
public class ImageLoaderManager {
        ...
        Glide.with(group.getContext())
                ...
                .into(new SimpleTarget<Bitmap>() {
                    ...
                    public void onResourceReady(@NonNull final Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                        // 加载过程和高斯模糊计算，如果不用 rx 会导致卡顿
                        Observable.just(resource)
                                .map(new Function<Bitmap, Drawable>() { // resource 转换 Drawable
                                    @Override
                                ...
                                .subscribeOn(Schedulers.io()) // 执行在 io 线程
                                .observeOn(AndroidSchedulers.mainThread()) // 返回给 ui 线程
    ...
    private RequestOptions initCommonRequestOption() {
        ...
        options.placeholder(R.mipmap.b4y) // 展位图
                .error(R.mipmap.b4y) // 加载失败时的图片
